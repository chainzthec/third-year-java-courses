...
public class Exercise4 {
    ...
    private void partFour(String[] args, Exercise4 exercice4) {
    ...
    private void partFive(String[] args, Exercise4 exercice4) {
        ExceptionHandler.verifyNumberOfArguments(args, 4);
    ...
    private void partSix(String[] args, Exercise4 exercice4) {
        ExceptionHandler.verifyNumberOfArguments(args, 4);
    ...
    private void partSeven(String[] args, Exercise4 exercice4) {
        ExceptionHandler.verifyNumberOfArguments(args, 4);
    ...
    public static void main(String[] args) {
        ExecutionTime.start();
        Exercise4 exercice4 = new Exercise4();
        //part 1
        ...
        System.out.println(exercice4.partTwo(3, testPartTwo1));
        System.out.println(exercice4.partTwo(3, testPartTwo2));
        //part 3
        System.out.println("--- PART 3 ---");
        String testPartThree1 = "defabc";
        String testPartThree2 = "sananes";
        System.out.println(exercice4.partThree(3, testPartThree1));
        System.out.println(exercice4.partThree(3, testPartThree2));
        //part 4
        System.out.println("--- PART 4 ---");
        //exercice4.partFour(args, exercice4); // exemple : java chapter1.exercises.Exercise4. bbac aacp /a acpa returns :  aacp is an anagram of acpa
        //part 5
        ...
        exercice4.partSeven(args, exercice4);
        ExecutionTime.end();
    }
}
